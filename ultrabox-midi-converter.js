 ...
 * * 目的:
 * JSONファイル内の正確な duration (ティック長) を使用し、切断されないMIDIを生成する。
 *
 * 依存ライブラリ:
...
// ===================================================================================
// 4. HTML DOM操作とメインエントリポイント (エラー報告を強化)
// ===================================================================================
        ...
        fileInput.addEventListener('change', (e) => {
            ...
            reader.onload = (event) => {
                try {
                    ...
                    // JSONは読めたが、UltraBox/BeepBox形式かチェック
                    ...
                    // JSON解析失敗、または上記 throw new Error でキャッチ
