...
// ===================================================================================
// 4. HTML DOM操作とメインエントリポイント (初期化チェックを追加)
// ===================================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (fileInput && convertButton) {
        // --- 修正: 初期化成功メッセージを追加 (これが表示されればJSは動いている) ---
        showMessage('✅ 初期化完了。JSONファイルを選択してください。', 'success');

        fileInput.addEventListener('change', (e) => {
            // ここから下は読み込み処理
            showMessage('', 'none'); // 初期化メッセージをクリア
        ...
        // HTML要素が見つからない場合のメッセージ
        showMessage("🚨 致命的エラー: HTML要素（入力欄やボタン）が見つかりません。index.htmlのIDを確認してください。", 'error');
    }
});
